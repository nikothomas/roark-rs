...
/// CallUploadResponse : Response after successfully uploading a call for analysis
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CallUploadResponse {
    /// Unique identifier assigned to the uploaded call
    #[serde(rename = "call_id")]
    pub call_id: uuid::Uuid,
}

impl CallUploadResponse {
    /// Response after successfully uploading a call for analysis
    pub fn new(call_id: uuid::Uuid) -> CallUploadResponse {
        CallUploadResponse {
            call_id,
        }
    }
