...
/// MetricValueType : Type of value stored in an evaluation metric: - numeric: Numerical score or measurement (e.g., 0.85, 7.5) - boolean: True/false evaluation result - text: Text-based evaluation result or category
/// Type of value stored in an evaluation metric: - numeric: Numerical score or measurement (e.g., 0.85, 7.5) - boolean: True/false evaluation result - text: Text-based evaluation result or category
...
impl std::fmt::Display for MetricValueType {
