...
pub struct CreateVapiCall201Response {
    #[serde(rename = "data")]
    pub data: models::CallUploadResponse,
}

impl CreateVapiCall201Response {
    pub fn new(data: models::CallUploadResponse) -> CreateVapiCall201Response {
