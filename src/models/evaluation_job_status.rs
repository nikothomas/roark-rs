...
/// EvaluationJobStatus : Evaluation job processing status: - pending: Job is queued and waiting to be processed - processing: Job is currently being evaluated - success: Evaluation completed successfully - failure: Evaluation failed due to an error
/// Evaluation job processing status: - pending: Job is queued and waiting to be processed - processing: Job is currently being evaluated - success: Evaluation completed successfully - failure: Evaluation failed due to an error
...
impl std::fmt::Display for EvaluationJobStatus {
...
impl Default for EvaluationJobStatus {
    fn default() -> EvaluationJobStatus {
        Self::Pending
    }
}
