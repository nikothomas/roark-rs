...
/// EvaluationEvidence : Supporting evidence for an evaluation result
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EvaluationEvidence {
    /// Unique identifier for the evidence
    #[serde(rename = "id")]
    pub id: uuid::Uuid,
    /// Text snippet from the call that supports the evaluation
    #[serde(rename = "snippet_text")]
    pub snippet_text: String,
    /// Evaluator's comment about this evidence
    #[serde(rename = "comment_text", skip_serializing_if = "Option::is_none")]
    pub comment_text: Option<String>,
    /// Whether this evidence supports a positive evaluation
    #[serde(rename = "is_positive")]
    pub is_positive: bool,
}

impl EvaluationEvidence {
    /// Supporting evidence for an evaluation result
    pub fn new(id: uuid::Uuid, snippet_text: String, is_positive: bool) -> EvaluationEvidence {
        EvaluationEvidence {
            id,
            snippet_text,
            comment_text: None,
