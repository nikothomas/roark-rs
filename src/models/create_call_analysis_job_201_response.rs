...
pub struct CreateCallAnalysisJob201Response {
    #[serde(rename = "data")]
    pub data: models::CallAnalysisJob,
}

impl CreateCallAnalysisJob201Response {
    pub fn new(data: models::CallAnalysisJob) -> CreateCallAnalysisJob201Response {
