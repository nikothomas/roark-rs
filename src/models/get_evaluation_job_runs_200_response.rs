...
pub struct GetEvaluationJobRuns200Response {
    #[serde(rename = "data")]
    pub data: models::GetEvaluationJobRuns200ResponseAllOfData,
}

impl GetEvaluationJobRuns200Response {
    pub fn new(data: models::GetEvaluationJobRuns200ResponseAllOfData) -> GetEvaluationJobRuns200Response {
        GetEvaluationJobRuns200Response {
            data,
        }
    }
}
