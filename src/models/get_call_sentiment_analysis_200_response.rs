...
pub struct GetCallSentimentAnalysis200Response {
    #[serde(rename = "data")]
    pub data: models::SentimentAnalysis,
}

impl GetCallSentimentAnalysis200Response {
    pub fn new(data: models::SentimentAnalysis) -> GetCallSentimentAnalysis200Response {
