...
pub struct GetEvaluationJob200Response {
    #[serde(rename = "data")]
    pub data: models::GetEvaluationJob200ResponseAllOfData,
}

impl GetEvaluationJob200Response {
    pub fn new(data: models::GetEvaluationJob200ResponseAllOfData) -> GetEvaluationJob200Response {
        GetEvaluationJob200Response {
            data,
        }
    }
}
