...
/// ApiResponse : Standard API response wrapper containing data and metadata
...
impl ApiResponse {
    /// Standard API response wrapper containing data and metadata
    pub fn new(data: Option<serde_json::Value>) -> ApiResponse {
        ApiResponse {
            data,
        }
    }
