...
pub struct GetEvaluationJobRuns200ResponseAllOfData {
    #[serde(rename = "pagination")]
    pub pagination: models::PaginationInfo,
    #[serde(rename = "runs")]
    pub runs: Vec<models::EvaluationRun>,
}

impl GetEvaluationJobRuns200ResponseAllOfData {
    pub fn new(pagination: models::PaginationInfo, runs: Vec<models::EvaluationRun>) -> GetEvaluationJobRuns200ResponseAllOfData {
