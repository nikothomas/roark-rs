...
pub struct ToolInvocationParametersValue {
    ...
    pub parameter_type: models::ToolParameterType,
    #[serde(rename = "value", deserialize_with = "Option::deserialize")]
    pub value: Option<serde_json::Value>,
}

impl ToolInvocationParametersValue {
    pub fn new(parameter_type: models::ToolParameterType, value: Option<serde_json::Value>) -> ToolInvocationParametersValue {
