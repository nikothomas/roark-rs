...
pub struct GetCallEvaluationRuns200Response {
    #[serde(rename = "data")]
    pub data: Vec<models::EvaluationRun>,
}

impl GetCallEvaluationRuns200Response {
    pub fn new(data: Vec<models::EvaluationRun>) -> GetCallEvaluationRuns200Response {
