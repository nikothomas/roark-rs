...
/// InterfaceType : Interface type used for the call: - phone: Traditional phone call (PSTN, SIP, etc.) - web: Web-based call (WebRTC, browser-based)
/// Interface type used for the call: - phone: Traditional phone call (PSTN, SIP, etc.) - web: Web-based call (WebRTC, browser-based)
