...
/// CallDirection : Direction of the call: - inbound: Customer initiated call to the agent - outbound: Agent initiated call to the customer
/// Direction of the call: - inbound: Customer initiated call to the agent - outbound: Agent initiated call to the customer
