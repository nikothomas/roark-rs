...
/// CallAnalysisJob : Analysis job information with associated call context
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CallAnalysisJob {
    /// Unique identifier for tracking the analysis job progress
    #[serde(rename = "job_id")]
    pub job_id: uuid::Uuid,
    #[serde(rename = "status")]
    pub status: models::JobStatus,
    #[serde(rename = "call")]
    pub call: models::CallData,
    /// When the analysis job was created
    #[serde(rename = "created_at", skip_serializing_if = "Option::is_none")]
    pub created_at: Option<String>,
    /// When the analysis job completed (null if still processing)
...
impl CallAnalysisJob {
    /// Analysis job information with associated call context
    pub fn new(job_id: uuid::Uuid, status: models::JobStatus, call: models::CallData) -> CallAnalysisJob {
        CallAnalysisJob {
            job_id,
            status,
            call,
