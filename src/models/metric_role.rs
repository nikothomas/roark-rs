...
/// MetricRole : Role of the metric in evaluation: - primary: Main evaluation metric used for scoring - secondary: Supporting metric providing additional context
/// Role of the metric in evaluation: - primary: Main evaluation metric used for scoring - secondary: Supporting metric providing additional context
...
impl Default for MetricRole {
    fn default() -> MetricRole {
        Self::Primary
    }
}
