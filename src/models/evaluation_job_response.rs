...
/// EvaluationJobResponse : Response for evaluation job operations
...
impl EvaluationJobResponse {
    /// Response for evaluation job operations
    pub fn new(job_id: uuid::Uuid, status: models::EvaluationJobStatus) -> EvaluationJobResponse {
