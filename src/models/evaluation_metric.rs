...
/// EvaluationMetric : Individual metric result from an evaluation run
...
pub struct EvaluationMetric {
    ...
    pub value_type: models::MetricValueType,
    /// Numeric value of the metric (for numeric metrics)
    #[serde(rename = "numeric_value", skip_serializing_if = "Option::is_none")]
    pub numeric_value: Option<f64>,
    /// Boolean value of the metric (for boolean metrics)
    #[serde(rename = "boolean_value", skip_serializing_if = "Option::is_none")]
    pub boolean_value: Option<bool>,
    /// Text value of the metric (for text metrics)
    #[serde(rename = "text_value", skip_serializing_if = "Option::is_none")]
    pub text_value: Option<String>,
    /// Confidence score of the metric evaluation (0-1)
    #[serde(rename = "confidence", skip_serializing_if = "Option::is_none")]
    pub confidence: Option<f64>,
    /// AI-generated explanation for the metric result
    #[serde(rename = "reasoning", skip_serializing_if = "Option::is_none")]
    pub reasoning: Option<String>,
    #[serde(rename = "role")]
    pub role: models::MetricRole,
}

impl EvaluationMetric {
    /// Individual metric result from an evaluation run
    pub fn new(id: uuid::Uuid, name: String, value_type: models::MetricValueType, role: models::MetricRole) -> EvaluationMetric {
        EvaluationMetric {
            id,
            name,
            value_type,
