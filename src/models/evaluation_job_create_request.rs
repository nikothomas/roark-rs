...
pub struct EvaluationJobCreateRequest {
    /// Single call to evaluate (use either call or dataset, not both)
    #[serde(rename = "call", skip_serializing_if = "Option::is_none")]
    pub call: Option<models::CallAnalysisCreateRequest>,
    #[serde(rename = "dataset", skip_serializing_if = "Option::is_none")]
    pub dataset: Option<models::EvaluationJobCreateRequestDataset>,
    #[serde(rename = "evaluators")]
    pub evaluators: models::EvaluationJobCreateRequestEvaluators,
}

impl EvaluationJobCreateRequest {
    /// Request to create a new evaluation job for calls or datasets
    pub fn new(evaluators: models::EvaluationJobCreateRequestEvaluators) -> EvaluationJobCreateRequest {
