...
/// HealthStatus : Health status of the API service: - healthy: All systems operational - degraded: Some non-critical systems experiencing issues - unhealthy: Critical systems down or experiencing major issues
/// Health status of the API service: - healthy: All systems operational - degraded: Some non-critical systems experiencing issues - unhealthy: Critical systems down or experiencing major issues
