...
pub struct CreateEvaluationJob201Response {
    #[serde(rename = "data")]
    pub data: models::EvaluationJobResponse,
}

impl CreateEvaluationJob201Response {
    pub fn new(data: models::EvaluationJobResponse) -> CreateEvaluationJob201Response {
