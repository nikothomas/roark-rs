...
/// ParticipantRole : Role of a call participant: - agent: AI voice agent or human agent handling the call - customer: End user or customer interacting with the agent
/// Role of a call participant: - agent: AI voice agent or human agent handling the call - customer: End user or customer interacting with the agent
