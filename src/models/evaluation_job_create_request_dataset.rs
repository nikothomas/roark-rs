...
/// EvaluationJobCreateRequestDataset : Dataset of calls to evaluate (use either call or dataset, not both)
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EvaluationJobCreateRequestDataset {
    /// Name of the dataset for identification
    #[serde(rename = "name")]
    pub name: String,
    /// List of calls to include in the dataset evaluation
    #[serde(rename = "calls")]
    pub calls: Vec<models::CallAnalysisCreateRequest>,
}

impl EvaluationJobCreateRequestDataset {
    /// Dataset of calls to evaluate (use either call or dataset, not both)
    pub fn new(name: String, calls: Vec<models::CallAnalysisCreateRequest>) -> EvaluationJobCreateRequestDataset {
        EvaluationJobCreateRequestDataset {
            name,
            calls,
        }
    }
