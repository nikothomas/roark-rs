...
pub struct GetApiHealth200Response {
    #[serde(rename = "data")]
    pub data: models::HealthResponse,
}

impl GetApiHealth200Response {
    pub fn new(data: models::HealthResponse) -> GetApiHealth200Response {
